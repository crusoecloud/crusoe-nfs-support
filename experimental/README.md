...
```
wget -O crusoe_shared_disks_nfs_setup.py https://github.com/crusoecloud/crusoe-nfs-support/raw/refs/heads/main/experimental/crusoe_shared_disks_nfs_setup.py
```
