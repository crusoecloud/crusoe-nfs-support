...
```
wget -O crusoe_shared_disks_virtiofs_to_nfs.py https://github.com/crusoecloud/crusoe-nfs-support/raw/refs/heads/main/archive/crusoe_shared_disks_virtiofs_to_nfs.py
```
